...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        rollout_name = "vllm_hqq" # self.config.rollout.name
        if rollout_name == "hf":
            ...
            rollout_sharding_manager = HQQFSDPVLLMShardingManager(
                module=self.actor_module_fsdp,
                inference_engine_full_precision=rollout.inference_engine_full_precision,
                inference_engine_hqq=rollout.inference_engine_hqq,
                model_config=self.actor_model_config,
                full_params=full_params,
                device_mesh=rollout_device_mesh,
                offload_param=self._is_offload_param,
